...
PL2019_2020_df = get_league_stats(PL2019_2020, 'chromedriver.exe', Path(os.getcwd(), 'data/d01_scraped_data/PL2019_2020.csv'))
LaLiga2019_2020_df = get_league_stats(LaLiga2019_2020, 'chromedriver.exe', Path(os.getcwd(), 'data/d01_scraped_data/LaLiga2019_2020.csv'))
Ligue1_2019_2020_df = get_league_stats(Ligue1_2019_2020, 'chromedriver.exe', Path(os.getcwd(), 'data/d01_scraped_data/Ligue1_2019_2020.csv'))
SeriaA_2019_2020_df = get_league_stats(SerieA_2019_2020, 'chromedriver.exe', Path(os.getcwd(), 'data/d01_scraped_data/SerieA_2019_2020.csv'))
Bundesliga_2019_2020_df = get_league_stats(Bundesliga_2019_2020, 'chromedriver.exe', Path(os.getcwd(), 'data/d01_scraped_data/Bundesliga_2019_2020.csv'))
